...
pub mod factory {
    soroban_sdk::contractimport!(
        file = "../aggregator/phoenix_contracts/phoenix_factory.wasm"
    );
}
...
#[allow(clippy::too_many_arguments)]
pub mod multihop {
    soroban_sdk::contractimport!(file = "../aggregator/phoenix_contracts/phoenix_multihop.wasm");
...
pub mod token_contract {
    soroban_sdk::contractimport!(
        file = "../aggregator/phoenix_contracts/soroban_token_contract.wasm"
    );
}
...
pub mod lp_contract {
    soroban_sdk::contractimport!(
        file = "../aggregator/phoenix_contracts/phoenix_pool.wasm"
    );
}
...
pub fn install_stake_wasm(env: &Env) -> BytesN<32> {
    soroban_sdk::contractimport!(
        file = "../aggregator/phoenix_contracts/phoenix_stake.wasm"
    );
    env.deployer().upload_contract_wasm(WASM)
}
